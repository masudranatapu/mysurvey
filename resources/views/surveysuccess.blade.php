...
<head>
    ...
    <title>Second International Conference on Earth and Environmental Sciences and Technology- Towards Climate
        Resilience and Sustainability</title>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;500;700&family=Poppins:wght@300;400;500;700&display=swap"
        rel="stylesheet">
        ...
        <div class="py-10">
            <div class="container">
                <label class="file-input max-w-[400px] mx-auto mb-7 flex border rounded overflow-hidden focus:outline-2 focus:outline-secondary ring-primary/20 cursor-pointer">
                    <input type="file" id="file" aria-label="File browser example" class="hidden">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4 lg:gap-10">
                    ...
                    <div class="text-center space-y-4">
                        <div class="w-24 h-24 rounded-full flex items-center justify-center mx-auto">
                            <img src="{{asset('frontend/img/icons/4.png')}}" alt="">
                        </div>
                    ...
                    <div class="text-center space-y-4">
                        <div class="w-24 h-24 rounded-full flex items-center justify-center mx-auto">
                            <img src="{{asset('frontend/img/icons/6.png')}}" alt="">
                        </div>
